...
header = (
    f"{'Model':<6} {'Hidden':>7} {'Inter':>8} {'GEMMs':>6} {'tok/s':>7} {'us/tok':>9} {'GFLOPS':>7} {'Total MAC':>12}"
)
print(header)
print("-" * len(header))
...
for name, spec in models.items():
    ...
    print(
        f"{name:<6} {spec['hidden']:>7} {spec['intermediate']:>8} {n_gemm:>6} {report.decode_tok_per_s:>7.1f} {report.decode_per_token_us:>9.0f} {gflops:>7.1f} {total_mac / 1e9:>9.2f}G"
    )
