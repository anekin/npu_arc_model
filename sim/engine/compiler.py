...
class NPUCompiler:
    ...
    def compile_decode(
        self, trace: list[tuple[int, int, int, int, str]], weight_preloaded: bool = False
    ) -> list[NPUInstruction]:
    ...
    def compile_prefill(self, trace: list[tuple[int, int, int, int, str]], prompt_len: int) -> list[NPUInstruction]:
